import "./EndingRes.css";

function EndingRes() {
  return (
    <div className="ER">
      <ul className="ER-List1">
        <li>Find A Store</li>
        <li>Become A Member</li>
        <li>Sign Up For Email</li>
        <li>Send Us Feedback</li>
      </ul>
      <div className="ER-HiddenList1">
        <div className="ER-HiddenList1Header">
          <p>Get Help</p>
          <p>+</p>
        </div>
      </div>
      <div className="ER-HiddenList2">
        <div className="ER-HiddenList2Header">
          <p>About Nike</p>
          <p>+</p>
        </div>
      </div>

      <div className="ER-IconContainer">
        <svg
          className="ER-TwitterIcon"
          width="30px"
          fill="#111"
          height="30px"
          viewBox="0 0 24 24"
      ...
      <div className="ER-LocationContainer">
        <svg
          className="ER-LocationIcon"
          height="15px"
          width="18px"
          fill="#111"
          viewBox="0 0 42 58"
      ...
      <p className="ER-Text">© 2022 Nike, Inc. All Rights Reserved</p>
      <ul className="ER-List2">
        <li>Guides</li>
        <li>Terms of Sale</li>
        <li>Terms of Use</li>
