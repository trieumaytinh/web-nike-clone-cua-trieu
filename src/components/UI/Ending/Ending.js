import "./Ending.css";
import "./EndingResponsive.css";

function Ending() {
  return (
    <div className="Ending">
      <div className="Ending-Top">
        <div className="Ending-TopLeft">
          <ul className="Ending-TopLeft1">
            <li>Find A Store</li>
            <li>Become A Member</li>
            <li>Sign Up For Email</li>
            <li>Send Us Feedback</li>
          </ul>
          <ul className="Ending-TopLeft2">
            <li>Get Help</li>
            <li>Order Status</li>
            <li>Delivery</li>
            <li>Returns</li>
        ...
        <div className="Ending-TopRight">
          <svg
            className="Ending-TwitterIcon"
            width="30px"
            fill="#111"
            height="30px"
            viewBox="0 0 24 24"
          ...
          <svg
            className="Ending-InstagramIcon"
            width="30px"
            fill="#111"
            height="30px"
            viewBox="0 0 24 24"
      ...
      <div className="Ending-Bottom">
        <div className="Ending-BottomLeft">
          <div className="Ending-BottomLeftLocation">
            <svg className='Ending-LocationIcon' height="15px" width="18px" fill="#111" viewBox="0 0 42 58">
            ...
            <p style={{fontSize: '10px', marginLeft: '8px'}}>Vietnam</p>
          </div>

          <p className="Ending-BottomLeftText" style={{color:'#7e7e7e', fontSize: '10px'}}>
            © 2022 Nike, Inc. All Rights Reserved
          </p>
        </div>
        <div className="Ending-BottomRight">
          <ul>
            <li>Guides</li>
            <li>Terms of Sale</li>
            <li>Terms of Use</li>
