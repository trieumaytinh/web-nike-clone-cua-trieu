import "./OneProductInCheckoutRes.css";
import { useContext, useRef, useState } from "react";
import { ProductContext } from "../../../store/ProductContext";
function OneProductInCheckoutRes(props) {
  ...
  return (
    <div className="OPICR">
      <div className="OPICR-ImageContainer">
        <img src={i592} alt="" />
      </div>
      <div className="OPICR-InfoContainer">
        <div className="OPICR-NamePriceContainer">
          <p>{name}</p>
          <p>{`$${price}`}</p>
        </div>
        <div className="OPICR-Info">
          <p>{`${gender}'s ${type}`}</p>
        </div>
        <div className="OPICR-SizeContainer">
        ...
        <div className="OPICR-IconContainer">
          <svg
            className="OPICR-HeartIcon"
            aria-hidden="true"
            focusable="false"
            viewBox="0 0 24 24"
            role="img"
...
export default OneProductInCheckoutRes;
